...
public class Ejercicio4 {
	...
	public static void main(String[] args) {
		...
		// Data recollection
		System.out.println(
				"[GM]The maelstrom filling the central apse of the temple suddenly splits open with a crack of thunder. "
		...
		switch (dado2) {	// Switch to translate the string to numeric from the second die
		...
		System.out.println("[Baeloth] Okay so I do " + res
				+ " necrotic damage tpo Tiamat. And beacause I have the staff of Orcus\r\n"
