...
public class Ejercicio3 {
	...
	DIVIDIR LOS NÚMEROS
	Después, el algoritmo debe pedirle al usuario que seleccione una opción y que haga la operación que marca esa opción, 
	mostrando por último el resultado de la operación elegida por el usuario. Si el usuario elige una opción incorrecta, 
	...
	public static void main(String[] args) {
		...
		//Estribillo
		switch (opcion) {	//Segun la opcion elegida sumara (caso 1), restará (caso 2), multiplicara(case 3) o dividira (caso 4)
			case 1:
